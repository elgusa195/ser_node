...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector("#btn-ingresar-in").addEventListener('mouseover', function() {
      document.querySelector("#btn-ingresar-in").setAttribute("src", "../img/btn-ingresar-up.jpg");
    });
  
    document.querySelector("#btn-ingresar-in").addEventListener('mouseout', function() {
      document.querySelector("#btn-ingresar-in").setAttribute("src", "../img/btn-ingresar.jpg");
    });
